...
Client _clientDeserialize(
  ...
  final object = Client(
    ...
    document: reader.readString(offsets[1]),
...
extension ClientQueryFilter on QueryBuilder<Client, Client, QFilterCondition> {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'document',
        value: '',
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> documentIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'document',
        value: '',
...
extension ClientQuerySortBy on QueryBuilder<Client, Client, QSortBy> {
  ...
  QueryBuilder<Client, Client, QAfterSortBy> sortByDocument() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'document', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> sortByDocumentDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClientQuerySortThenBy on QueryBuilder<Client, Client, QSortThenBy> {
  ...
  QueryBuilder<Client, Client, QAfterSortBy> thenByDocument() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'document', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> thenByDocumentDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'document', Sort.desc);
    });
  }
...
extension ClientQueryWhereDistinct on QueryBuilder<Client, Client, QDistinct> {
  ...
  QueryBuilder<Client, Client, QDistinct> distinctByDocument(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ClientQueryProperty on QueryBuilder<Client, Client, QQueryProperty> {
  ...
  QueryBuilder<Client, String, QQueryOperations> documentProperty() {
    return QueryBuilder.apply(this, (query) {
